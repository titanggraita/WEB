<nav class="navbar navbar-expand-lg bg-nav fixed-top">
  <a class="navbar-brand" style="margin-left:50px; margin-bottom:200px;" href="<?= base_url() ?>user/public"><img src="<?= base_url() ?>assets/gambar/batan1.png" class="img-brand"></a>
  <div class="row">
    <h4 style="color:#EEE8AA; margin-left:30px;margin-bottom:100px;">Welcome, Public!</h4>
    <div class="topnav" style="margin-left:285px;">
      ...
      <a href="<?= base_url() ?>user/Open_question"><button type="button" class="btn btn-info" style="margin-top:-10px; color:#EEE8AA;">Open Question</button></a>
      <a href="<?= base_url() ?>C_login/logout"><button type="button" class="btn btn-info" style="margin-left:-5px; margin-top:-10px; color:#EEE8AA;">Log Out</button></a>
    </div>
