            ...
            <div class="p-4">    
                <form action="" method="POST">
                    <div class="form-group">
                        ...
                        <a style="color:#3AAFA9;">Pertanyaan :</a> <input type="text" class="form-control" id="uname" placeholder="pertanyaan" name="pertanyaan" value="<?php echo $fk->pertanyaan?>">
                    </div>
                    <div class="form-group">
                    <a style="color:#3AAFA9;">Jawaban :</a><input type="text" class="form-control" id="txt" placeholder="jawaban" name="jawaban" value="<?php echo $fk->jawaban?>">
                    </div>
