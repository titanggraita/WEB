            ...
            <div class="p-4">    
                <form action="" method="POST">
                    <div class="form-group">
                        ...
                        <a style="color:#3AAFA9;">Pertanyaan :</a><input type="text" class="form-control" id="pertanyaan" placeholder="pertanyaan" name="pertanyaan" value="<?php echo $AK->pertanyaan ?>" readonly>
                    </div>
                    <div class="form-group">
