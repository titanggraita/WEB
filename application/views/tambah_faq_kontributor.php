...
<nav class="navbar navbar-expand-lg bg-nav fixed-top">
  ...
  <div class="row">
      <h4 style="color:#EEE8AA; margin-left:10px;margin-top:10px;">Welcome, Kontributor!</h4>
...
<div id="box1" style="margin-top:100px;margin-left:460px;">
            <div class="p-4">    
                <form action="" method="POST">
                    <div class="form-group">
                        <p style="color:#3AAFA9;font-size:30px; margin-left:120px;">TAMBAH FAQ</p>
                        <a style="color:#3AAFA9;">Pertanyaan :</a> <input type="text" class="form-control" id="uname" placeholder="pertanyaan" name="pertanyaan">
                    </div>
                    <div class="form-group">
                    <a style="color:#3AAFA9;">Jawaban :</a><input type="text" class="form-control" id="txt" placeholder="jawaban" name="jawaban">
                    </div>
