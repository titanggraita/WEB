...
<div class="sidebar">
  ...
  <center style="margin-top:100px;"><h4>DATA KATEGORI FAQ</h4></center><br>
	...
	<center><table style="margin:20px auto;" border="1">
		...
		<tr>
			...
			<td>
            <?php echo anchor('crud/edit/'.$k['ID_kategori'],'Edit'); ?>
                          <?php echo anchor('crud/hapus/'.$k['ID_kategori'],'Hapus'); ?>  
			</td>
		</tr>
		<?php } ?>
	</table>
