...
<div class="sidebar">
  ...
  <a href="#"><i class="fa fa-fw fa-users"></i> Public</a><br>
  <a href="#"><i class="fa fa-fw fa-users"></i> Contributor</a><br>
  <a href="<?php base_url()?>"><i class="fa fa-fw fa-question-circle"></i> Question</a><br>
  <a href="#"><i class="fa fa-fw fa-bookmark"></i> Category</a>  
